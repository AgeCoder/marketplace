...
const page = async ({ params }: Params) => {
    ...
    return (
        <section className='px-4 md:px-8 mx-auto mb-10'>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-4 mb-2">
                ...
                <div className="flow-root rounded-lg border border-gray-200  py-3 shadow-md">
                    <dl className="-my-3 divide-y divide-gray-100 text-sm">
                        ...
                        <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                            <dt className="font-medium text-gray-900">Creater</dt>
                            <dd className="text-gray-700 sm:col-span-2">
                                {data?.User?.firstName + ' ' + data?.User?.lastName}</dd>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                            ...
                            <dd className="text-gray-700 sm:col-span-2">{new Intl.DateTimeFormat("en-US", {
                                dateStyle: "long"
                            }).format(data?.createdAt)}</dd>
                        </div>
            ...
            <div className='mt-2'>
                {/* <h3 className='font-extrabold mb-5 text-xl' >Description</h3> */}
